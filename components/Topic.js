            ...
            <Animated.View
                ...
                <View style={[styles.titleContainer]} onLayout={this._setMinHeight.bind(this)}>
                    <TouchableHighlight
                        ...
                        <View style={{ flexDirection: 'row', borderBottomColor: '#c9b7b7', borderBottomWidth: .5, justifyContent:'center', alignItems:'center', padding:10 }}>
                            <Text style={[styles.title, { flex: 1,  fontWeight: '700' }]}>{this.props.title}</Text>
                            {this.state.expanded ?
                                <View >
